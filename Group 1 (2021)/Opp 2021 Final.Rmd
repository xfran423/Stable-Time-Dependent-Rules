...
#######################################################LOOP#END#######################################################
 #write.csv(masterframe_opp.df, "C:/Users/Xmanf/Desktop/Ch1 TDR files/opp2021countmaster_336sec.csv")
...
#masterframe_opp.df <- read.csv("C:/Users/Xmanf/Desktop/Ch1 TDR files/opp2021countmaster_336sec.csv", header=TRUE, stringsAsFactors=FALSE)
...
#visualize observed rule follow vs reference distribution
 opp_2021_count_plot <-ggplot(rand_opp_.frame, aes(x=random_times_opp_followed)) + 
  ...
  scale_x_continuous(name = "Count of Opportunism events", breaks=seq(0, 200, 50)) +  
     coord_cartesian(xlim = c(0, 200), ylim = c(0,.050)) +
...
#p = .002 for no restrictions less often 
#p = .297 for 8 sec as often 
# p = .033 for 85 sec less often 
# p = 0 for 336 sec less often
...
#write.csv(masterframe_opp.df_time_2021, "C:/Users/Xmanf/Desktop/Ch1 TDR files/opp2021timemaster.csv")
...
#masterframe_opp.df_time_2021 <- read.csv("C:/Users/Xmanf/Desktop/Ch1 TDR files/opp2021timemaster.csv", header=TRUE, stringsAsFactors=FALSE)
