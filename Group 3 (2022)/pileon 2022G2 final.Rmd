...
#seed = 21 for no restriction
#seed = 738  for 8 sec
#seed =  65 for 85 seconds
#seed = 115  for 336 seconds
#set seed
set.seed(115)
#forloop starts here'
...
#######################################################LOOP#END#######################################################
#write.csv(masterframe_pileon2022G2.df, "C:/Users/Xmanf/Desktop/Ch1 TDR files/pileon2022G2countmaster_336sec.csv")
...
#masterframe_pileon2022G2.df <- read.csv("C:/Users/Xmanf/Desktop/Ch1 TDR files/pileon2022G2countmaster_336sec.csv", header=TRUE, stringsAsFactors=FALSE)
...
pile_tally2022G2 <-length(which(rand_pile_.frame_2022G2$random_times_pile_on_followed < pile_real_2022G2))

finalpile_tally2022G2 <- 1- pile_tally2022G2/length(rand_pile_.frame_2022G2$random_times_pile_on_followed)

#p= .031 for unrestricted
#p = .21 for 8 sec
#p = .078 for 85 sec
#p for 336 sec p = 0.042
```
...
#write.csv(masterframe_pileon.df_time_2022G2, "C:/Users/Xmanf/Desktop/Ch1 TDR files/pile2022G2timemaster.csv")
```
...
#masterframe_pileon.df_time_2022G2 <- read.csv("C:/Users/Xmanf/Desktop/Ch1 TDR files/pile2022G2timemaster.csv")
#raw data 
